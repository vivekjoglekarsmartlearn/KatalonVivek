...
WebUI.setText(findTestObject('Object Repository/TestListener/Page_TestProject Demo/input_Full Name_name'), 'Ravikanth')
...
WebUI.setText(findTestObject('Object Repository/TestListener/Page_TestProject Demo/input_Address_address'), '7783 stereet')

WebUI.setText(findTestObject('Object Repository/TestListener/Page_TestProject Demo/input_Email_email'), 'ravi@gmail.com')
